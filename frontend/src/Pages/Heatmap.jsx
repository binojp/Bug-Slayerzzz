...
const TrashMap = () => {
  ...
  return (
    <MapContainer center={mapCenter} zoom={14} style={{ height: '100vh', width: '100%' }}>
      <TileLayer
        ...
        >
          <Popup>
            <div style={{ fontFamily: 'sans-serif' }}>
              ...
              <button style={{ width: '100%', padding: '8px', border: 'none', backgroundColor: '#E53935', color: 'white', cursor: 'pointer' }}>
                View Details
              </button>
            </div>
          </Popup>
